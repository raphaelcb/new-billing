...
import br.com.cpqd.SpringBootBillingCompanyApplication;
...
@EnableJpaRepositories(basePackageClasses = SpringBootBillingCompanyApplication.class, repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class)
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan(SpringBootBillingCompanyApplication.class.getPackage().getName());
