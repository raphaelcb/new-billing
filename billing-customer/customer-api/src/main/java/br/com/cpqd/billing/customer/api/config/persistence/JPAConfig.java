package br.com.cpqd.billing.customer.api.config.persistence;
...
import br.com.cpqd.SpringBootBillingCustomerApplication;
...
@EnableJpaRepositories(basePackageClasses = SpringBootBillingCustomerApplication.class, repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class)
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan(SpringBootBillingCustomerApplication.class.getPackage().getName());
    ...
    private void validateJPABasicInformations() throws JPAConfigException {
        ...
        String pathConfigFile = this.env.getProperty("APP_DB_HOME");
