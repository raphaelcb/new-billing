...
public class CustomerSwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                        ...
                        .description("Documentação da API de integração entre sistemas externos e o microserviço de Cliente do CPqD Billing")
    ...
    private Tag tagCustomer() {
        ...
        return new Tag("Cliente", "Operações relacionadas a clientes", 0);
    }
